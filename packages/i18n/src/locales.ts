...
export const LOCALES: ReadonlyArray<LocaleDescriptor> = [
  { tag: 'en-US', nativeName: 'English (US)', defaultCurrency: 'USD', defaultTaxLabel: 'Sales tax' },
  { tag: 'en-GB', nativeName: 'English (UK)', defaultCurrency: 'GBP', defaultTaxLabel: 'VAT 20%' },
  { tag: 'id-ID', nativeName: 'Bahasa Indonesia', defaultCurrency: 'IDR', defaultTaxLabel: 'PPN 11%' },
